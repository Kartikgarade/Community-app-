...
window.app = {
    ...
    login: async () => {
        ...
        try {
            ...
            // Show the actual error on screen so you can debug on the phone
    ...
    renderAnn: () => {
        const c=document.getElementById('ann-feed'); if(!c) return; c.indocument.addEventListener("DOMContentLoaded", () => {
  try {
    localStorage.setItem("test", "ok");
    localStorage.removeItem("test");
    console.log("localStorage enabled");
